...
void copiarLista(tLista origen, tLista *destino) {
    ...
    if (!esListaVacia(origen)) {
        ...
        tNodo *primerNodo = (tNodo *) malloc(sizeof(tNodo));
        asignarElemento(&primerNodo -> elemento, nodoOrigen -> elemento);
        primerNodo -> siguiente = NULL;
        primerNodo -> anterior = NULL;
        destino -> principio = primerNodo;
        destino -> final = primerNodo;
        ...
        while (nodoOrigen  != NULL) {
            ...
            nodoNuevo -> anterior = destino -> final;
            destino -> final -> siguiente = nodoNuevo;
