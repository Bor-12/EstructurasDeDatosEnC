...
void insertarOrdenadoInicio(tLista *lista, tElemento elemento) {
    tNodo *actual = *lista;
    tNodo *anterior = NULL;
    while (actual != NULL && mayor(actual -> elemento, elemento)){
        anterior = actual;
...
void insertarOrdenadoFinal(tLista *lista, tElemento elemento) {
    tNodo *actual = *lista;
    tNodo *anterior = NULL;
    while (actual != NULL && (mayor(actual->elemento, elemento) || igualElemento(actual->elemento, elemento))){
        anterior = actual;
        actual = actual -> siguiente;
    }
    tNodo *nuevoNodo = (tNodo*) malloc(sizeof(tNodo));
...
void eliminarElemento(tLista *lista, tElemento elemento) {
    ...
    while (actual != NULL && !igualElemento(actual->elemento, elemento)) {
        anterior = actual;
        actual = actual->siguiente;
    }
